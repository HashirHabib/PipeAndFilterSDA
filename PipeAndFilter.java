...
public class PipeAndFilter {
    ...
    public static void main(String[] args) {
        List<Integer> input = List.of(22, 23, 32, 46, 51, 62, 77, 82, 91, 105);
        ...
        filters.add(PipeAndFilter::filterOddNumbers); // New filter for odd numbers
        filters.add(PipeAndFilter::cubeNumbers);      // New filter for cube of numbers
